...
def us1():
           ...
           # ua f"[FBAN/FB4A;FBAV/{fbav};FBBV/480086274;FBDM/{density=3.0,width=1080,height=1920};FBLC/en_US;FBRV/0;FBCR/Zong;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-A-K116C2;FBSV/9;FBBK/0;FBOP/1;FBCA/x86:armeabi-v7a;]"
            ua = f"[FBAN/FB4A;FBAV/{facebook_version};FBBV/{fbbv};[FBAN/FB4A;FBAV/{facebook_version};FBLC/{fblc};FBBV/{fbbv};FBCR/{fbcr};FBMF/samsung;FBBD/samsung;FBPN/{fbpn};FBDV/SM-G925L;FBSV/7.0;FBCA/armeabi-v7a:armeabi;FBDM/"+"{"+f"density={density},width={width},height={height}]"
        #    print(ua)
